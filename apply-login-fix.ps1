...
# It writes the fixed Login.tsx via a here-string (no manual pasting/truncation),
# then stages, commits, and pushes it.

$ErrorActionPreference = "Stop"

$targetPath = "artifacts/web-app/src/pages/auth/Login.tsx"
...
git commit -m "fix: surface real API error text on login instead of generic 'not connected to server'"

git push

Write-Host "Done. Redeploy on Vercel, then try logging in again and read the exact error in the toast."